...
const tabSelectButtonVariants = cva('p-4 transition-colors duration-75', {
  variants: {
    variant: {
      default:
        'text-slate-400 data-[selected=true]:text-black data-[selected=false]:hover:text-slate-500',
      accent:
        'text-slate-500 transition-[color,font-weight] data-[selected=true]:text-blue-600 data-[selected=false]:hover:text-slate-700 data-[selected=true]:font-medium',
    },
  },
  defaultVariants: {
    variant: 'default',
