    ...
    >
      <Dialog.Portal>
        <Dialog.Overlay
          ...
          id="modal-backdrop"
          className="animate-fade-in fixed inset-0 z-[100] bg-slate-100/50 backdrop-blur-sm"
        />
        <Dialog.Content
          ...
          className={cn(
            'fixed inset-0 z-[100] m-auto h-fit w-full max-w-md',
        ...
        >
          ...
          <ScrollArea className="max-h-[90vh] overflow-y-scroll">
            {children}
          </ScrollArea>
        </Dialog.Content>
      </Dialog.Portal>
